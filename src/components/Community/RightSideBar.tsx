...
const RightSideBar = ({ selectedSection }: any) => {
  console.log('images', selectedSection.additional_images);
  ...
  return (
    <div className="flex w-full flex-col items-center justify-start space-y-8 bg-white p-6 shadow dark:bg-dark-3 lg:w-1/5">
      {
        images?.length > 0 && <div className="flex w-full flex-col items-center rounded-md bg-gray-50 p-4 text-center shadow-sm dark:bg-dark-4">
